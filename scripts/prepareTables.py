...
list_datacards [ 'em1j13               '  ]  =       [    'ggH/Moriond/datacards/hww2l2v_13TeV_em_1j/mllVSmth/datacard.txt.pruned.txt'                  ,    'False'    ]    #   'True'    ]
list_datacards [ 'me1j13               '  ]  =       [    'ggH/Moriond/datacards/hww2l2v_13TeV_me_1j/mllVSmth/datacard.txt.pruned.txt'                  ,    'False'    ]    #   'True'    ]
list_datacards [ 'em0j13               '  ]  =       [    'ggH/Moriond/datacards/hww2l2v_13TeV_em_0j/mllVSmth/datacard.txt.pruned.txt'                  ,    'False'    ]    #   'True'    ]
list_datacards [ 'me0j13               '  ]  =       [    'ggH/Moriond/datacards/hww2l2v_13TeV_me_0j/mllVSmth/datacard.txt.pruned.txt'                  ,    'False'    ]    #   'True'    ]
...
list_datacards [ 'of2j2j13             '  ]  =       [    'ggH2j/Moriond/datacards/hww2l2v_13TeV_of2j/mllVSmth/datacard.txt.pruned.txt'                 ,    'False'    ]    #   'True'    ]
...
list_datacards [ 'of2jvbf13            '  ]  =       [    'VBF/Moriond/datacards/hww2l2v_13TeV_of2j_vbf_lowmjj/mll/datacard.txt.pruned.txt'             ,    'False'    ]    #   'True'    ]
...
list_datacards [ 'of2jvh2j13           '  ]  =       [    'VH2j/Moriond/datacards/hww2l2v_13TeV_of2j_vh2j/mll/datacard.txt.pruned.txt'                  ,    'False'    ]    #   'True'    ]
...
list_datacards [ 'wh3lossf             '  ]  =       [    'WH3l/Moriond/datacards/wh3l_13TeV_ossf/drllmin3l/datacard.txt.pruned.txt'                    ,    'False'    ]    #   'True'    ]
list_datacards [ 'wh3lsssf             '  ]  =       [    'WH3l/Moriond/datacards/wh3l_13TeV_sssf/drllmin3l/datacard.txt.pruned.txt'                    ,    'False'    ]    #   'True'    ]
...
list_datacards [ 'ICHEP_em_mp_1j_13    '  ]  =       [    'ggH/datacards/hww2l2v_13TeV_em_mp_1j/mllVSmth/datacard.txt.pruned.txt'                       ,    'False'    ]    #   'True'    ]
list_datacards [ 'ICHEP_me_mp_1j_13    '  ]  =       [    'ggH/datacards/hww2l2v_13TeV_me_mp_1j/mllVSmth/datacard.txt.pruned.txt'                       ,    'False'    ]    #   'True'    ]
list_datacards [ 'ICHEP_em_mp_0j_13    '  ]  =       [    'ggH/datacards/hww2l2v_13TeV_em_mp_0j/mllVSmth/datacard.txt.pruned.txt'                       ,    'False'    ]    #   'True'    ]
list_datacards [ 'ICHEP_me_mp_0j_13    '  ]  =       [    'ggH/datacards/hww2l2v_13TeV_me_mp_0j/mllVSmth/datacard.txt.pruned.txt'                       ,    'False'    ]    #   'True'    ]
list_datacards [ 'ICHEP_em_pm_1j_13    '  ]  =       [    'ggH/datacards/hww2l2v_13TeV_em_pm_1j/mllVSmth/datacard.txt.pruned.txt'                       ,    'False'    ]    #   'True'    ]
list_datacards [ 'ICHEP_me_pm_1j_13    '  ]  =       [    'ggH/datacards/hww2l2v_13TeV_me_pm_1j/mllVSmth/datacard.txt.pruned.txt'                       ,    'False'    ]    #   'True'    ]
list_datacards [ 'ICHEP_em_pm_0j_13    '  ]  =       [    'ggH/datacards/hww2l2v_13TeV_em_pm_0j/mllVSmth/datacard.txt.pruned.txt'                       ,    'False'    ]    #   'True'    ]
list_datacards [ 'ICHEP_me_pm_0j_13    '  ]  =       [    'ggH/datacards/hww2l2v_13TeV_me_pm_0j/mllVSmth/datacard.txt.pruned.txt'                       ,    'False'    ]    #   'True'    ]
...
list_datacards [ 'ICHEP_of2j2j13       '  ]  =       [    'ggH2j/datacards/hww2l2v_13TeV_of2j/mllVSmth/datacard.txt.pruned.txt'                         ,    'False'    ]    #   'True'    ]
...
list_datacards [ 'ICHEP_of2jvbf13      '  ]  =       [    'VBF/datacards/hww2l2v_13TeV_of2j_vbf_lowmjj/mllfine/datacard.txt.pruned.txt'                 ,    'False'    ]    #   'True'    ]
...
list_datacards [ 'ICHEP_of2jvh2j13     '  ]  =       [    'VH2j/datacards/hww2l2v_13TeV_of2j_vh2j/mll/datacard.txt.pruned.txt'                          ,    'False'    ]    #   'True'    ]
...
list_datacards [ 'ICHEP_wh3lossf       '  ]  =       [    'WH3l/datacards/wh3l_13TeV_ossf/drllmin3l/datacard.txt.pruned.txt'                            ,    'False'    ]    #   'True'    ]
list_datacards [ 'ICHEP_wh3lsssf       '  ]  =       [    'WH3l/datacards/wh3l_13TeV_sssf/drllmin3l_sssf/datacard.txt.pruned.txt'                       ,    'False'    ]    #   'True'    ]
